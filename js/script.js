...
jQuery(function ($) {
   ...
   $(".scroll").on('click', function (event) {
      ...
      $('.side-nav.side-nav-right.full-nav.menu-nav').removeClass('side-nav-open');
      $("html,body").animate({
...
$(document).mousemove(function(e) {
 ...
 $('#vtab-1.non-active').click(function() {

    //console.log("Clicked");
    $('#vtab-2.non-active.active').removeClass('active');
    $('#vtab-3.non-active.active').removeClass('active');
    // $(this).addClass('active');
});
  $('#vtab-2.non-active').click(function() {

    //console.log("Clicked");
    $('#vtab-1.non-active.active').removeClass('active');
    $('#vtab-3.non-active.active').removeClass('active');
    // $(this).addClass('active');
});
   $('#vtab-3.non-active').click(function() {
...
$('#aqua').click(function() {
    ...
    //console.log("Clicked");
    $('#aqua').addClass('active');
    $('#storm.active').removeClass('active');
    $('#fire.active').removeClass('active');
    // $(this).addClass('active');
});

$('#aqua.non').click(function() {
    //console.log("Clicked");
    
    $('#aqua.non').addClass('active');
    $('#storm.non.active').removeClass('active');
    $('#fire.non.active').removeClass('active');
    // $(this).addClass('active');
});

$('#storm.non').click(function() {
    //console.log("Clicked");
    $('#storm.non').addClass('active');
    $('#aqua.non.active').removeClass('active');
    $('#fire.non.active').removeClass('active');
   // $(this).addClass('active');
});

$('#fire.non').click(function() {
    //console.log("Clicked");
    $('#fire.non').addClass('active');
    $('#aqua.non.active').removeClass('active');
    $('#storm.non.active').removeClass('active');
    // $(this).addClass('active');
});
  ...
  $('#storm').click(function() {
    ...
    //console.log("Clicked");
    $('#storm').addClass('active');
    $('#aqua.active').removeClass('active');
    $('#fire.active').removeClass('active');
    // $(this).addClass('active');
});
   $('#fire').click(function() {
